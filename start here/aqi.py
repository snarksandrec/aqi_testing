...
## VARIABLES 
AQI_DEVICE_ID = 2 # 1: INDOOR | 2: OUTDOOR
...
if __name__ == "__main__":
	...
	## NEW: Copy aqi.json file to Github https://github.com/snarksandrec/aqi
	...
	print("\nCopying " +  AQI_JSON + " to GitHub - https://github.com/snarksandrec/aqi_outdoor")
	...
	sheet = client.open("aqi").get_worksheet(AQI_DEVICE_ID - 1)
	...
	print("Updating Google Doc sheet " + str(AQI_DEVICE_ID) + " to https://bit.ly/36H0y7W")
